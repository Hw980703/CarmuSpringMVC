                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <section id="infoChange">
                                  ...
                                  <form action="/member/nicName.do?memberId=${member.memberId}" method = "post">  <article class="infoChangeRighjt"> <input type="text" name="userNik" id="userNim" placeholder="닉네임을 입력하세요(한글 최대 6자리)"><button id="nikBtn" class="infoChangeBtn" >수정  </a></button></article> </article> </form>
                                     <form action="/member/pwChange.do?memberId=${member.memberId}" method = "post">   <article class="infoChangeTag"> <article class=infoChangeLeft>현재 비밀번호</article>
                                    ...
                                    <article class="infoChangeRighjt" > <input type="text" name="userNewPw" id="userNewPw" placeholder="변경 할 비밀번호를 입력하세요(숫자최대10)"><br>${msg}</article>  </article>
                                    ...
                                    <form action="/member/emailChange.do?memberId=${member.memberId}" method = "post"> <article class="infoChangeTag"> <article class=infoChangeLeft> 이메일 </article>
                                    <article class="infoChangeRighjt" ><input type="text" name="userEm" id="userEm" placeholder="이메일 주소를 입력하세요 @ 포함"><button id="edBtn" class="infoChangeBtn">인증번호 발송</button></article> </article>
                                        <article class="infoChangeTag"> <article class=infoChangeLeft>  </article>
                                    <article class="infoChangeRighjt" > <input type="text" name="userPhoneChec" id="userPhoneChec" class= "userPhoneChec" placeholder="인증번호4자리"><button id="edcon" class="infoChangeBtn">인증</button></article> </article> </form>
                                        <article class="infoChangeTag"> <article class=infoChangeLeft> </article>
