		...
		<header id="title">
			...
			<header id="titleMain">
					...
					<header id="menu">
						<article id="menuTag">
							<ul id="menuUl">
								...
								<li class="menuClass"><a href="/member/info.do">정보수정
								</a></li>
				...
				<nav id="nav">
					...
					<article id="navTest">
						<ul id="navul">
							<li><a href="../notice/KorFreelist.do" id="korNav"
					...
					<section id="category">
						<article class="navaCtegory" id="korCategory">
							<a href="../notice/KorFreelist.do">자유게시판</a> <a
					...
					<article id="login">
						...
						<section id="login-bottom">
							<article id="login-bottom-footer">
								<ul id="footer-ul">
									<div id=footer-IDPW>
										<li><a href="/member/info.do">내 정보수정</a></li>
									</div>
						...
						<article id="write">
							<article id="korCar">
								...
								<ul id="korCarUl">
									...
									<li><a href="../notice/KorFreelist.do" class="sideA">
											-자유게시판 </a></li>
