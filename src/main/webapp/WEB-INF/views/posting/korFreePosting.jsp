                            ...
                            <section id="loginTag">
                                ...
                                <section id="writeTitle">
                                    <article id="writeTitleText">
                                       ${korFreeBoard.korFreeBoardSubject}[2]
                                    </article>
                                    <article id="writeTitleDate">
                                            ${korFreeBoard.korFreeBoardDate}
                                    </article>
                                </section>
                                ...
                                <section id="writeMaincenter">
                                    <article id="writeP">
                                               ...
                                               <pre>   ${korFreeBoard.korFreeBoardContent}</pre>
                                            </article>
                                    <article id="writegood">
                                        <button id="writeGoodBtn">추천 1</button>
                                    </article>
                                    <article id="writeBtn">
                                        <button id="writeChange"> <a href = "/korboard/update.do?korFreeBoardNo=${korFreeBoard.korFreeBoardNo}"> 수정 </a></button>
                                        <button id="writeRemove"> <a href = "/korboard/delete.do?korFreeBoardNo=${korFreeBoard.korFreeBoardNo}"> 삭제 </a> </button>
                                    </article>
                                </section>
...
//             })
            document.querySelector("#writeChange").addEventListener("click",()=>{
                location.href="/korboard/update.do?korFreeBoardNo=${korFreeBoard.korFreeBoardNo}"
            })
